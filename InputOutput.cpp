...
Inputs ReadParameters(char* fname)
{
    ...
    else if (strcmp(var_name,"divide_mean")==0)
			divide_mean = atof(var_value);
    else if (strcmp(var_name,"divide_std_dev")==0)
			divide_std_dev = atof(var_value);
    else if (strcmp(var_name,"septum_std_dev")==0)
      septum_std_dev = atof(var_value);
